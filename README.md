...
### Warning:
- This mod requires you to be using a newer experimental version of CDDA. It will not work on Stable 0.F-3! **Also** the latest CDDA patch has broken the healing system, so until this gets patched, you'll want a version from before around Jan 26th.
